    ...
    function update_keysanity_dungeons(dungeons, opts) {
        dungeons = update(dungeons, {
            ...
            darkness: { $merge: {
                ...
                doors: function() {
                    var reach_arena = function(items) {
                    ...
                    return {
                        ...
                        boss: {
                            ...
                            can_reach: can_enter_and_then(function(items) {
                                var keys = this.keys_left();
                                return items.has_bow() && (keys >= 2 || keys && items.hammer);
                            }, available_or_dark)
                        },
                        front: {
                            caption: 'Front',
            ...
            turtle: { $merge: {
                ...
                spent_keys: function() {
                    return sum(map(this.doors, property('opened'))) - !this.locations.big_key.marked;
                },
                doors: {
                    crystaroller: {
                        caption: 'Crystaroller',
                        can_reach: can_enter_state_if(function() { return this.keys - this.spent_keys() >= 3 && this.big_key; })
                    },
                    boss: {
                        caption: 'Boss',
                        can_reach: can_enter_and_then(function() { return this.keys - this.spent_keys() >= 3 && this.big_key; }, medallion_or_dark)
                    }
                },
                locations: function() {
                    var laser_bridge = can_enter_and_then(function(items) {
                        return (items.cape || items.byrna || items.shield === 3) && this.doors.crystaroller.opened && this.big_key;
                    }, medallion_or_dark);

                    return {
                        big_key: {
                            caption: 'Big Key Chest',
                            can_reach: can_enter_state_if(function() { return this.keys - this.spent_keys() >= 3; })
                        },
                        compass: {
                            caption: 'Compass Chest',
                            second_map: true,
                        ...
                        boss: {
                            ...
                            second_map: true,
                            can_reach: can_enter_and_then(function(items) {
                                return this.doors.boss.opened && this.big_key && items.firerod && items.icerod;
                            }, medallion_or_dark)
                        }
                    };
                }()
